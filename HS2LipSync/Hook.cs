...
namespace Karenia.Hs2Lipsync
{
    ...
    {
        const string Guid = "me.rynco.hs2-lipsync";
        const string PluginName = "HS2Lipsync";
        ...
        private void AddConfigs()
        {
            ...
            LipsyncConfig.Instance.OverdriveFactor = base.Config.Bind<float>("General", "Overdrive Factor", 1.5f, new ConfigDescription("How much would this plugin try to overdrive when morphing the mouth shape. Making it too large could lead to weird faces.", new AcceptableValueRange<float>(0f, 3f)));
            LipsyncConfig.Instance.enabled = base.Config.Bind<bool>("General", "Enabled", true);
        }
    }
    ...
    namespace Hooks
    {
        ...
        public static class UpdateBlendShapeHook
        {
            ...
            public static void NewUpdateBlendShape(ChaControl __instance)
            {
                ...
                var voice = AccessTools.PropertyGetter(typeof(ChaControl), "fbsaaVoice").Invoke(__instance, new object[] { }) as LipDataCreatorHack;
        ...
        public static class AssistHook
        {
            ...
            {
                var ctrl = new LipDataCreatorHack(__instance.chaID);
                AccessTools.PropertySetter(typeof(ChaControl), "fbsaaVoice").Invoke(__instance, new object[] { ctrl });
        ...
        public static class BlendShapeHook
        {
            ...
            {
                [(int)OVRLipSync.Viseme.aa] = (int)LipTypes.A,
                ...
                [(int)OVRLipSync.Viseme.oh] = (int)LipTypes.O,
                [(int)OVRLipSync.Viseme.ou] = (int)LipTypes.O,
                [(int)OVRLipSync.Viseme.PP] = (int)LipTypes.N,
                [(int)OVRLipSync.Viseme.RR] = (int)LipTypes.A,
                // sil does nothing. It has contribution set to 0 below.
                [(int)OVRLipSync.Viseme.sil] = (int)LipTypes.Default,
                [(int)OVRLipSync.Viseme.SS] = (int)LipTypes.SmileTeeth,

                // /th/ is not seen in faces
                [(int)OVRLipSync.Viseme.TH] = (int)LipTypes.I,
            };
            ...
            {
                (int) LipTypes.LickLeftCorner,
                (int) LipTypes.OpenMouthSlight,
                (int) LipTypes.OpenMouthLarge,
                (int) LipTypes.Kiss,
                (int) LipTypes.OpenMouthExtraLarge,
            };
            ...
            private static void MapFrame(in OVRLipSync.Frame frame, ref Dictionary<int, float> faceDict, ref float openness)
            {
                ...
                var overdriveFactor = LipsyncConfig.Instance.OverdriveFactor.Value;
                ...
                {
                    const int laughId = (int)LipTypes.Smile;
